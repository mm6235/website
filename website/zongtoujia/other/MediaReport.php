...
<div class="warp">	
	...
	<section  class="g-warp zt-zhoverview">
		<nav class="nav"><a href="/">首页</a><em class="icon am-icon-angle-right"></em><a href="javascript:void(0)">媒体报道</a></nav>
		<div class="am-u-sm-2 zt-unav">
			<ul class="nav">
				<li><a href="/other/">关于我们<i class="am-icon-angle-right"></i></a></li>
				<li class="active"><a href="MediaReport.php">媒体报道<i class="am-icon-angle-right"></i></a></li>
				<li><a href="Announcement.php">平台公告<i class="am-icon-angle-right"></i></a></li>
				<li><a href="ArticleCenter.php">帮助中心<i class="am-icon-angle-right"></i></a></li>
				<li><a href="ContactUs.php">联系我们<i class="am-icon-angle-right"></i></a></li>
			</ul>
		</div>
  		<div class="am-u-sm-10 zt-synopsis">
			<div class="con">
				<h3 class="title">媒体报道</h3>
				<div class="am-g news">
			  		<dl>
			  			<a href="">
				  			<dd class="avt"><img src="/assets/image/zthq.jpg" alt=""></dd>
			  		...
			  		<dl>
			  			<a href="">
				  			<dd class="avt"><img src="/assets/image/zthq.jpg" alt=""></dd>
				  			<dt class="tie">阿道夫沙德法师范振绪出现的v安分守德法师范振绪出现的v安分守发</dt>
				  			<dd class="note">阿萨德法师范振绪出现的v安分守拙放</dd>
				  			<dd class="time">2016-4-11</dd>			  				
			  			</a>
			  		</dl>
			  		<dl>
			  			<a href="">
				  			<dd class="avt"><img src="/assets/image/zthq.jpg" alt=""></dd>
				  			<dt class="tie">阿道夫沙德法师范振绪出现的v安分守德法师范振绪出现的v安绪出现的v安分守德法师范振绪出现的v安绪出现的v安分守德法师范振绪出现的v发</dt>
				  			<dd class="note">阿萨德法师法师范振绪出现的v安分守德法师范振绪出现的v安绪出现的v安分守德法师范振绪出现的v安绪出现的v安分守德法师范振范振绪出现的v安分守拙放</dd>
				  			<dd class="time">2016-4-11</dd>			  				
			  			</a>
			  		</dl>
				</div>
