		...
		var httpData = function( xhr, type, s ) { // mostly lifted from jq1.4.4
           ...
           if(expResult == null)
           {
            alert(data);
				...
				var html = '<div class="filetype"><a class="del am-btn am-btn-danger am-round"href="javascript:void(0)">×</a><input type="text" placeholder="请输入文件类型名称（例：身份证）"><div class="preview">'+data+"</div></div>";
