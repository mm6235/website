...
<body>
	<div class="warp">	
		...
		<section class="m-personal " id="js-personal">
			<!-- 用户注册 -->
			<article class="row m-register"id="js-register">
				<!-- 切换 -->
				...
				<form class="" id="js-userregister" autocomplete="off">
					...
					<div class="profil col-md-12">
						...
						<div class="form-group verify">
							...
							<a class="btn btn-default col-md-4 teltxt" href="javascript:void(0)" onclick="this.childNodes[0].src = this.childNodes[0].src+'?'"><img src="/assets/image/vdimgck.jpg" alt=""></a>
							<span></span>            
						</div>
						<div class="form-group">
