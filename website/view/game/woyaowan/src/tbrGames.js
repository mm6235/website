...
//			var html = '<div class="box"><span class="m">00</span>:<span class="s">'+time+'</span>:<span class="ms">00</span></div>';
			//时间不显示分钟数，只显示秒，毫秒数 （明明）
			var html = '<div class="box"><span class="m"></span><span class="s">'+time+'</span>:<span class="ms">00</span></div>';
			var sStr = time;
			$(dom).html(html);
		...
		gameOver : function(){
			...
			$.ajax({
				type:"get",
				url:"/public/static/youxi/woyaowan/module/gameover.html",
				dataType : 'html',
		...
		gameInit : function(){
			$.ajax({
				type:"get",
				url:"/public/static/youxi/woyaowan/module/gameinit.html",
				dataType : 'html',
				success : function(data){
					setTimeout(function(){
						// 载入场景到页面中
		...
		nextlevel : function(){
			...
			$.ajax({
				type:"get",
				url:"/public/static/youxi/woyaowan/module/level"+TGM.statistics.level+".html",
				dataType : 'html',
				success : function(data){
					setTimeout(function(){
						// 载入场景到页面中
